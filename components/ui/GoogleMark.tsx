/**
 * Google's four-colour "G". Reproduced unmodified because Google's branding
 * guidelines require the official mark on Sign in with Google buttons —
 * don't recolour it to match the theme.
 */
